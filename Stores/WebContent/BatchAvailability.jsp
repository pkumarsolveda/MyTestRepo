...
com.ibm.commerce.messaging.batchavailabilityrequest.*,
...
try
{
            ...
            com.ibm.commerce.domain.order.BatchAvailabilityRequest requestObj = (com.ibm.commerce.domain.order.BatchAvailabilityRequest) reqProperties.get("requestObj");   

            java.util.Hashtable result = new java.util.Hashtable();
            result = BatchAvailabilityRequestConverter.convertRequestObjectToXSDBean(requestObj);
            com.ibm.commerce.messaging.batchavailabilityrequest.batchAvailabilityRequest xsdBean = (batchAvailabilityRequest)(result.get("request"));
            batchAvailabilityRequestFactory factory = (batchAvailabilityRequestFactory)(result.get("factory"));
