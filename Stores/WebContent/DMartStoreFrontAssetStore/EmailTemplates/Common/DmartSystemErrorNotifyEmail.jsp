...
<c:set var="salutationName" value="Admin"/>
								...
								<tr>
									<td align="left" valign="bottom">
										<h3
											...
											<fmt:message bundle="${emailText}" key="SALUTATION_TEXT"/> ${salutationName}
										</h3>
									</td>
								...
								<tr>
									<td>
										<p
											...
											<fmt:message bundle="${emailText}" key="SYSTEM_ERROR_TEXT1"/> 
											<br/>
											<fmt:message bundle="${emailText}" key="SYSTEM_ERROR_TEXT3"/>  ${errorCode}
											<br/>
											<fmt:message bundle="${emailText}" key="SYSTEM_ERROR_TEXT4"/>  ${errorMessage}
											<br/>
											<br/>
											<fmt:message bundle="${emailText}" key="SYSTEM_ERROR_TEXT2"/> 
											${errorTrace} 
										</td>
								</tr>
							</table></td>
