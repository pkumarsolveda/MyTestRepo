									...
									<td>
										<p
											...
											<fmt:parseDate value="${order.x_slotDate}" var="parsedDate" pattern="dd-MMM-yyyy" />
												<fmt:message bundle="${emailText}" key="PICKUP_REMINDER_EMAIL_TEXT_1">
													<fmt:param>${WCParam.pupIdentifier}</fmt:param>
													<fmt:param>${slotTime}</fmt:param>
													<fmt:param>${slotDate}</fmt:param>
												</fmt:message>
												<br/><br/>
												<fmt:message bundle="${emailText}" key="PICKUP_REMINDER_EMAIL_TEXT_2" />
												<br/><br/>
												<fmt:message bundle="${emailText}" key="PICKUP_REMINDER_EMAIL_TEXT_3" />
												<br/><br/>
												<fmt:message bundle="${emailText}" key="PICKUP_REMINDER_EMAIL_TEXT_4" />
												<br/><br/>
												<fmt:message bundle="${emailText}" key="PICKUP_REMINDER_EMAIL_TEXT_5" />
												<br/><br/>
												${WCParam.pupAddress}
												<br/><br/>
												<fmt:message bundle="${emailText}" key="PICKUP_REMINDER_EMAIL_TEXT_6">
													<fmt:param>${WCParam.contactUs}</fmt:param>
													<fmt:param>${WCParam.contactUsEmail}</fmt:param>
												</fmt:message><br/><br/>																						  
										</td>
								</tr>
							</table></td>
