								...
								<tr>
									<td>
										<p
											...
											<br/>
											<br/>
											<fmt:message bundle="${emailText}" key="REFUND_INITIATED_EMAIL_TEXT_1">
												<fmt:param>${WCParam.orderId}</fmt:param>		
											</fmt:message>
											<br/>
											<br/>
											<fmt:message bundle="${emailText}" key="REFUND_INITIATED_EMAIL_TEXT_2">
												<fmt:param>${WCParam.refundAmount}</fmt:param>
												<fmt:param>${paymentMethod}</fmt:param>
											</fmt:message>
											<br/>
											<br/>
											<fmt:message bundle="${emailText}" key="REFUND_INITIATED_EMAIL_TEXT_3">
