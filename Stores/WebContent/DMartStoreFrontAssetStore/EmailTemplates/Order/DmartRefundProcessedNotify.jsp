								...
								<tr>
									<td align="left" valign="bottom">
										<h3
											...
											<fmt:message bundle="${emailText}" key="SALUTATION_TEXT"/> ${memberDetails.address.firstName} ${memberDetails.address.lastName},
										</h3>
									</td>
									<td align="right"><a href="${DMartHomePage}"> <img
											src="${imagesBaseURL}/dmart-logo.png"
											width="150px">
									</a>
									</td>
								</tr>
								...
								<tr>
									<td>
										<p
											...
											<fmt:message bundle="${emailText}" key="GREETINGS_TEXT"/>  
											<br/>
											<br/>
											<fmt:message bundle="${emailText}" key="REFUND_PROCESSED_EMAIL_TEXT_1">
												<fmt:param>${WCParam.orderId}</fmt:param>
												<fmt:param>456</fmt:param>
											</fmt:message>
											<br/>
											<br/>
											<fmt:message bundle="${emailText}" key="REFUND_PROCESSED_EMAIL_TEXT_2" />
											<br/>
											<br/>
											<fmt:message bundle="${emailText}" key="REFUND_PROCESSED_EMAIL_TEXT_3" />
											<br/>
										</td>
								</tr>
							</table></td>
							...
							<table width="100%" cellpadding="0" cellspacing="0" border="0"
								...
								<tr>
										...
										<p
											...
											<I></><fmt:message bundle="${emailText}" key="BOTTOM_TAGLINE_2"/></I> </p></td>
								</tr>
							</table>
						</td>
					</tr>
											...
											<tr>
												<td width="50%">
													<h5
														...
														<fmt:message bundle="${emailText}" key="SOCIAL_TEXT"/>
													</h5>
												</td>
												<td><a href="${FacebookPage}"
													style="text-decoration: none"> <img
														src="${imagesBaseURL}/temp/email/facebook.png">
												</a> <a href="${GooglePlusPage}" style="text-decoration: none"> <img
														src="${imagesBaseURL}/temp/email/google.png">
												</a></td>
											</tr>
										</table></td>
					...
					<tr>
						<td valign="top" align="left">
							<p
								...
								<fmt:message bundle="${emailText}" key="COPYRIGHT_TEXT"/></p></td>
