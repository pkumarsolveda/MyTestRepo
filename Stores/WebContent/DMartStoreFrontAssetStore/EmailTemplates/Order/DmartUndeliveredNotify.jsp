								...
								<tr>
									<td>
										<p
											...
											<br/>
											<br/>
											<fmt:message bundle="${emailText}" key="ORD_UNDELIVERED_EMAIL_TEXT_1">
											...
											<br/>
											<br/>
											<fmt:message bundle="${emailText}" key="ORD_UNDELIVERED_EMAIL_TEXT_2" />
											<br/>
											<br/>
											<fmt:message bundle="${emailText}" key="ORD_UNDELIVERED_EMAIL_TEXT_3" >
