...
<title><fmt:message bundle="${storeText}" key="EMAIL_CHGNOT_TITLE"></fmt:message></title>
					...
					<tr>
						<td width="600px" align="center" valign="middle">
							<p
								...
								<fmt:message bundle="${storeText}" key="EMAIL_CHGNOT_DAILY_DISC"></fmt:message></p></td>
					</tr>
				</table></td>
			<td>&nbsp;</td>
		</tr>
							...
							<table width="100%" cellpadding="0" cellspacing="0" border="0"
								...
								<tr>
									<td align="left" valign="bottom">
										<h3
											style="font-family: Calibri, Arial, sans-serif; font-size: 20px; font-weight: normal; padding: 0; margin: 0"><fmt:message bundle="${emailText}"
												key="SALUTATION_TEXT_NAME">
								...
								<tr>
									<td>
										<p
											...
											<fmt:message bundle="${storeText}" key="EMAIL_CHGNOT_MESSAGE1">
											...
											<br/><br/>
											<fmt:message bundle="${storeText}" key="EMAIL_CHGNOT_MESSAGE2">
											</fmt:message>
											<br/><br/>
											<fmt:message bundle="${storeText}" key="EMAIL_CHGNOT_MESSAGE3">
