									...
									<tr>
										<td>
											<table style="border-collapse: collapse; border-spacing: 0; margin: 0 auto; width: 558px; color: #404040; font-size: 12px;" role="presentation">
												...
												<tr>
												<td>
												Please click the below link to verify the Email ID for your DMart account-(Customer ID ${memberId})
												</td>
												</tr>
												<tr></tr>
												<tr>
												<td>Verification Link  : <a id="verificationUrl">  ${validationLink} </a>	</td>
												</tr>
												<tr></tr>
												<tr>
												<td>Thanks,</td>
