								...
								<tr>
									<td align="left" valign="bottom">
										<h3
											...
											<fmt:message bundle="${storeText}" key="MOB_CHG_EMAIL_HELLO">
								...
								<tr>
									<td>
										<p
											...
											<fmt:message bundle="${emailText}" key="GREETINGS_DMART"></fmt:message><br/><br/>
											<fmt:message bundle="${storeText}" key="MOB_CHG_EMAIL_MESSAGE_1">
											...
											<fmt:message bundle="${storeText}" key="MOB_CHG_EMAIL_MESSAGE_2">
												<fmt:param>${fn:escapeXml(oldLogonId)}</fmt:param>
												<fmt:param>${fn:escapeXml(newLogonId)}</fmt:param>
											</fmt:message><br/> <br/>
											<fmt:message bundle="${storeText}" key="MOB_CHG_EMAIL_MESSAGE_3">
