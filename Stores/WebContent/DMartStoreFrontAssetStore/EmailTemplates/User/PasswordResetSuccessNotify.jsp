							...
							<td style="margin: 0; padding: 0; background-image: url('${fullJspStoreImgDir}${env_vfileColor}email_template/border_left.png'); background-repeat: repeat-y; width: 7px;"></td>
								...
								<table style="border-collapse: collapse; border-spacing: 0;" role="presentation">
									...
									<tr>
										<td>
											<table
												style="border-collapse: collapse; border-spacing: 0; margin: 0 auto; width: 558px; color: #404040; font-size: 12px;"
												role="presentation">
												<tr>
												...
												<tr></tr>
												<tr>
													<td>The password for your DMart.in account (Customer ID ${memberId}) has been changed.</td>
												</tr>
												<tr></tr>
												<tr>
													<td>If you didn't make this change, please call our customer care number <3251232751> for assistance.</td>
												</tr>
												<tr></tr>
												<tr>
												<tr></tr>
												...
												<tr></tr>
												<tr>
													<td>Your &#8216;best value&#8217; one-stop shop for the entire family</td>
												</tr>
												<tr>
													<td>Daily discounts daily savings!</td>
												</tr>
