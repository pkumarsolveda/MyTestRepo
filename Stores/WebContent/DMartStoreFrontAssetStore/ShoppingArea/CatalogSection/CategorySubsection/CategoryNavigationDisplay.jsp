...
<%
	...
	String canonicalURL = "http://"+serverName+requestURL;
	pageContext.setAttribute("CategoryDisplayURL", canonicalURL);
%>
...
<c:if test="${empty catGroupDetailsView.catalogGroupView[0].seo_token_ntk}">
