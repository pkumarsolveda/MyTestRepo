...
xmlns:waistate="http://www.w3.org/2005/07/aaa" lang="${shortLocale}" xml:lang="${shortLocale}">
	<head>
		...
		<title><c:out value="${seoTitle}" escapeXml="false"/></title>
		<meta name="description" content="<c:out value="${metaDescription}" />"/>
		<meta name="keywords" content="<c:out value="${metaKeyword}" escapeXml="false" />"/>
		...
		<c:set var="pageGroup" value="HomePage" />
...
<input id="homePageIndicatorHidden" name="homePageIndicatorHidden" value="Y" type="hidden">
