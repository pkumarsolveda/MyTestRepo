				...
				<flow:ifEnabled feature="RecurringOrders">
					...
					<div id="scheduling_options" style="display: block;">
						...
						<form name="RecurringOrderForm">
							...
							>
								<img class="info_on" src="<c:out value='${jspStoreImgDir}${vfileColor}icon_info_ON.png'/>" alt="Order"/>
								<img class="info_off" src="<c:out value='${jspStoreImgDir}${vfileColor}icon_info.png'/>" alt="Order"/>
							</span>
