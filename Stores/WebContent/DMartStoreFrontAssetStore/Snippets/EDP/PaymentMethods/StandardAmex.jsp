	...
	<span class="col1">
		<span class="card_number">
			<span>
				...
				<span><fmt:message bundle="${storeText}" key="EDPPaymentMethods_AMEX_CARD_NUMBER" /></span></label>
			</span>
			<span>
