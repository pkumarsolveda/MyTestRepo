										...
										<div class="shipping_billing_content" id="normal">
											<div id="my_account_billing" role="region" aria-labelledby="my_account_billing_acce_label">
												...
												<jsp:include page="${env_siteWidgetsDir}com.ibm.commerce.store.widgets.AddressForm/AddressForm.jsp" flush="true">
													<jsp:param name="addressId" value="${billingTemp_addressId}" />
													<jsp:param name="nickName" value="${billingTemp_nickName}" />
													<jsp:param name="addressType" value="${billingTemp_addressType}" />
													...
													<jsp:param name="address1" value="${billingTemp_address1}"/>
													<jsp:param name="address2" value="${billingTemp_address2}"/>
													<jsp:param name="city" value="${billingTemp_city}"/>
													<jsp:param name="state" value="${billingTemp_state}"/>
													...
													<jsp:param name="prefix" value="billing_" />
													<jsp:param name="pageName" value="QuickCheckoutAddressForm" />
													<jsp:param name="formName" value="document.QuickCheckout.name"/>
												</jsp:include>
											...
											<div id="my_account_shipping" role="region" aria-labelledby="my_account_shipping_acce_label">
												...
												<div id="shipAddr">
													<jsp:include page="${env_siteWidgetsDir}com.ibm.commerce.store.widgets.AddressForm/AddressForm.jsp" flush="true">
														<jsp:param name="addressId" value="${shippingTemp_addressId}" />
														<jsp:param name="nickName" value="${shippingTemp_nickName}" />
														<jsp:param name="addressType" value="${shippingTemp_addressType}" />
														...
														<jsp:param name="address1" value="${shippingTemp_address1}"/>
														<jsp:param name="address2" value="${shippingTemp_address2}"/>
														<jsp:param name="city" value="${shippingTemp_city}"/>
														<jsp:param name="state" value="${shippingTemp_state}"/>
														...
														<jsp:param name="prefix" value="shipping_" />
														<jsp:param name="pageName" value="QuickCheckoutAddressForm" />
														<jsp:param name="formName" value="document.QuickCheckout.name"/>
													</jsp:include>															
												</div>
