					...
					<div class="rowContainer" id="container_reqList_detail">
						...
						<div class="row margin-true">
							...
							<div class="col8 acol12 ccol9 right">		
								<%out.flush();%>
								<c:import url="${env_siteWidgetsDir}com.ibm.commerce.store.widgets.RequisitionListInfo/RequisitionListInfo.jsp">			
								...
								<%out.flush();%>
								<c:import url="${env_siteWidgetsDir}com.ibm.commerce.store.widgets.RequisitionListItems/RequisitionListItems.jsp">
									<c:param name="storeId" value="${storeId}" />
									<c:param name="catalogId" value="${catalogId}" />
									<c:param name="langId" value="${langId}" />
									<c:param name="requisitionListId" value="${requisitionListId}" />
