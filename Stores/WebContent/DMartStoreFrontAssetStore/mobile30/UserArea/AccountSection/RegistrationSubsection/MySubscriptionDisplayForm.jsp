					...
					<fieldset>
						...
						<form method="post" action="RESTUserRegistrationUpdate" id="my_subscriptions_texting_form">
							...
							<div class="item_wrapper item_wrapper_gradient">
								...
								<input type="text" id="mobileCountryCode1" name="mobileCountryCode" class="inputfield input_width_60" size="4" value="${countryCode}" readonly="readonly" tabindex="-1"/>
								<label for="mobilePhone1"><span style="display:none;"><fmt:message bundle="${storeText}" key="MOMS_MOBILE_PHONE_NUMBER"/></span></label>
								<input type="tel" id="mobilePhone1" name="mobilePhone1" class="inputfield input_width_standard" value="${mobilePhoneNumber1}"/>
							</div>
