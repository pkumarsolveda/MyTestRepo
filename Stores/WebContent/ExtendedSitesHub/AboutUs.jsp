...
<html>
<head>
	<title><%= storeText.getString("aboutusTitle") %></title>
...
<table cellpadding="0" cellspacing="0" border="0" width="100%">
	...
	<jsp:include page="<%=incfile%>" flush="true">
		...
		<jsp:param name="actionSelected" value="aboutus" />
      	</jsp:include> 
	<!-- End Navigation -->
		</td>
		...
		<!-- End Header -->
			<table cellpadding="0" cellspacing="0" border="0" width="100%">
				<tr>
					<td class="contentspc">
						<table cellpadding="0" cellspacing="0" border="0">
							<tr>
								<td>
				<h1><%= storeText.getString("aboutusTitle") %></h1>
				<table cellpadding="0" cellspacing="0" border="0" width="616">
					<tr>
						<td width="349" class="titlebar"><%= storeText.getString("aboutusSubHeading") %></td>
				...
				<table cellpadding="0" cellspacing="0" border="0" width="616">
					<tr>
						<td><%= storeText.getString("aboutusSubHeadingDescription1") %>
						<p><%= storeText.getString("aboutusSubHeadingDescription2") %></p>
						<p><%= storeText.getString("aboutusSubHeadingDescription3") %></p>
						</td>
					</tr>
				</table>
				<br />
