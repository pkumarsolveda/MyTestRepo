...
if (isApproved) {
	heading = storeText.getString("registrationSuccessWithoutApprovalHeading");
	description = storeText.getString("registrationSuccessWithoutApprovalDescription");
} else {
	heading = storeText.getString("registrationSuccessPendingApprovalHeading");
	description = storeText.getString("registrationSuccessPendingApprovalDescription");
}
%>
...
<html>
<head>
	<title><%= storeText.getString("registrationSuccessTitle") %></title>
	...
	<!-- End Navigation -->
		...
		<!-- End Header -->
			<table cellpadding="0" cellspacing="0" border="0" width="100%">
				...
				<h1><%= storeText.getString("registrationSuccessTitle") %></h1>
				
				<table cellpadding="0" cellspacing="0" border="0" width="616">
					<tr>
						<td width="349" class="titlebar"><%= heading %></td>
