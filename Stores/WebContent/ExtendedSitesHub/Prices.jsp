...
<html>
<head>
	<title><%= storeText.getString("pricesTitle") %></title>
...
<table cellpadding="0" cellspacing="0" border="0" width="100%">
	...
	<jsp:include page="<%=incfile%>" flush="true">
		...
		<jsp:param name="actionSelected" value="prices" />
      	</jsp:include> 
	<!-- End Navigation -->
		</td>
		...
		<!-- End Header -->
			<table cellpadding="0" cellspacing="0" border="0" width="100%">
				...
				<h1><%= storeText.getString("pricesTitle") %></h1>
				<table cellpadding="0" cellspacing="0" border="0" width="616">
					<tr>
						<td width="349" class="titlebar"><%= storeText.getString("pricesSubHeading1") %></td>
				...
				<table cellpadding="0" cellspacing="0" border="0" width="616">
					<tr>
						<td><%= storeText.getString("pricesDescription1") %>
				
				<p><%= storeText.getString("pricesDescription1a") %>
				
				<ol>
				  <li><%= storeText.getString("pricesDescription1aBullet1") %><br>
				  </li>
				  <li><%= storeText.getString("pricesDescription1aBullet2") %><br>
				  </li>
				  <li><%= storeText.getString("pricesDescription1aBullet3") %>
				  </li>
				</ol>
				
				<p><%= storeText.getString("pricesDescription1b") %></p>
					</td>
					</tr>
				</table>
				<br />
				...
				<table cellpadding="0" cellspacing="0" border="0" width="616">
					<tr>
						<td width="349" class="titlebar"><%= storeText.getString("pricesSubHeading2") %></td>
						<td align="right" width="267"><img src="<%= fileDir %>images/title_bar_grad.jpg" width="267" height="23" border="0" alt=""></td>
					</tr>
					<tr>
						<td colspan="2"><img src="<%= fileDir %>images/title_bar_line.gif" width="616" height="4" border="0" alt=""></td>
				...
				<table cellpadding="0" cellspacing="0" border="0" width="616">
					<tr>
					<td>
				  <h2><%= storeText.getString("pricesService1") %></h2>
				    <%= storeText.getString("pricesServiceDescription1") %>
				    
				  <h2><%= storeText.getString("pricesService2") %></h2>
				    <%= storeText.getString("pricesServiceDescription2") %>
				  <h2><%= storeText.getString("pricesService3") %></h2>
				    <%= storeText.getString("pricesServiceDescription3") %>
				  <h2><%= storeText.getString("pricesService4") %></h2>
				    <%= storeText.getString("pricesServiceDescription4") %>
				    	</td>
					</tr>
				</table>
				<br />
