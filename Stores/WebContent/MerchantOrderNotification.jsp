...
try{
	...
	if (storeName != null) {
		...
		messageBuffer.append(orderNotificationRB.getString("MerchantOrderNotificationStore"));
		messageBuffer.append(" ");
		messageBuffer.append(storeName);
		out.println(messageBuffer.toString());
	}
	
	messageBuffer = new StringBuffer();
	messageBuffer.append(orderNotificationRB.getString("MerchantOrderNotificationOrderNumber"));
	messageBuffer.append(" ");
	messageBuffer.append(orderId);
	out.println(messageBuffer.toString());
	out.println( orderNotificationRB.getString("MerchantOrderNotificationDescription") );
	out.println( orderNotificationRB.getString("delimeter") );

	out.println( orderNotificationRB.getString("MerchantOrderNotificationShippingInfo") );
	out.println("");
	...
	if (distinctShipAddressId != null) {
		for (int i=0; i<distinctShipAddressId.length; i++) {
			out.println( orderNotificationRB.getString("MerchantOrderNotificationShippingRecipient") );
	...
	if (indexes2 != null) {
		out.println( orderNotificationRB.getString("MerchantOrderNotificationShippingRecipient") );
		out.println("");
		out.println( orderNotificationRB.getString("MerchantOrderNotificationShippingNA") );
    		out.println("");
	...
	out.println("");
	out.println( orderNotificationRB.getString("MerchantOrderNotificationOrderInformation") );
	out.println("");
	out.println( TextAlignHelper.leftAlign(orderNotificationRB.getString("MerchantOrderNotificationOrderDiscount"), HEADING_SIDE, ENCODING)	+ TextAlignHelper.rightAlign(orderSummaryDB.getOrderLevelDiscountForDisplay(), NUMBER_SIDE, ENCODING) );
	out.println( TextAlignHelper.leftAlign(orderNotificationRB.getString("MerchantOrderNotificationMinusAdjustment"), HEADING_SIDE, ENCODING)	+ TextAlignHelper.rightAlign(orderSummaryDB.getOrderLevelMinusAdjustment(), NUMBER_SIDE, ENCODING) );
	out.println( TextAlignHelper.leftAlign(orderNotificationRB.getString("MerchantOrderNotificationShipping"), HEADING_SIDE, ENCODING)		+ TextAlignHelper.rightAlign(orderSummaryDB.getFormattedTotalShippingCharges(), NUMBER_SIDE, ENCODING) );
	out.println( TextAlignHelper.leftAlign(orderNotificationRB.getString("MerchantOrderNotificationShippingTax"), HEADING_SIDE, ENCODING)		+ TextAlignHelper.rightAlign(orderSummaryDB.getFormattedTotalShippingTax(), NUMBER_SIDE, ENCODING) );
	out.println( TextAlignHelper.leftAlign(orderNotificationRB.getString("MerchantOrderNotificationTax"), HEADING_SIDE, ENCODING)		+ TextAlignHelper.rightAlign(orderSummaryDB.getFormattedTotalTax(), NUMBER_SIDE, ENCODING) );
	out.println( TextAlignHelper.leftAlign(orderNotificationRB.getString("MerchantOrderNotificationOrderTotal"), HEADING_SIDE, ENCODING)	+ TextAlignHelper.rightAlign(orderSummaryDB.getOrderGrandTotal(), NUMBER_SIDE, ENCODING) );
	out.println( TextAlignHelper.leftAlign(orderNotificationRB.getString("MerchantOrderNotificationCurrency"), HEADING_SIDE, ENCODING)	+ TextAlignHelper.rightAlign(orderSummaryDB.getOrderCurrency(), NUMBER_SIDE, ENCODING) );
	out.println("");
	out.println( orderNotificationRB.getString("separator") );
	...
	out.println("");
	out.println(orderNotificationRB.getString("MerchantOrderNotificationBillingInfo"));
	out.println("");
		
	//Display payment information and status
	out.println(orderNotificationRB.getString("MerchantOrderNotificationPaymentInfo"));
	out.println("");
	out.print(orderNotificationRB.getString("MerchantOrderNotificationPaymentStatus"));
	out.print(" ");
	...
	while (iteForPI.hasNext()) {
		...
		out.print(orderNotificationRB.getString("MerchantOrderNotificationPaymentMethod"));
		out.print(" ");
		out.println(aPI.getPaymentMethod());
		out.print(orderNotificationRB.getString("MerchantOrderNotificationPaymentAmount"));
		out.print(" ");
		out.println(formatAmount(aPI.getAmount(), orderDB.getCurrency(), storeAB, storeAB.getLanguageIdInEJBType()));
		String accountNumber = (String) protocolData.get("account");
		if (accountNumber == null) {
			accountNumber = "";
		}
		out.print(orderNotificationRB.getString("MerchantOrderNotificationPaymentAccount"));
		out.print(" ");
		out.println(accountNumber);
		out.print(orderNotificationRB.getString("MerchantOrderNotificationPaymentBillAddress"));
		out.print(" ");
	...
	//out.println(orderNotificationRB.getString("MerchantOrderNotificationPaymentMethod") + orderSummaryDB.getPaymentMethodDescription());
