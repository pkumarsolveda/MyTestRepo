...
try{
	...
	someText.append(System.getProperty("line.separator"));
	String message = orderNotificationRB.getString("orderCancelHeaderMsg");
	...
	someText.append(orderNotificationRB.getString("orderCancelContactStore"));
	someText.append(System.getProperty("line.separator"));
	...
	if (storeAddressDB.getEmail1() != null) {
		someText.append(orderNotificationRB.getString("orderCancelEmail"));
		someText.append(" ");
		someText.append(storeAddressDB.getEmail1());
		someText.append(System.getProperty("line.separator"));
	}
	if (storeAddressDB.getPhone1() != null) {
		someText.append(orderNotificationRB.getString("orderCancelPhone"));
		someText.append(" ");
