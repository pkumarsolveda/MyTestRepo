...
try {
	...
	for (int i = 0;
		...
		out.print(" ");
		out.println(getFormattedQuantity(afirstOrderItems[i].getQuantityInEJBType().doubleValue(), jLocale));
		out.print("          ");
		...
		out.print(" ");
		out.println(UIUtil.toHTML(formatTimestamp(afirstOrderItems[i].getTimeShippedInEJBType(), jLocale)));
		out.print("          ");
		...
		out.println(
			UIUtil.toHTML(
				formatAmount(
					afirstOrderItems[i].getPriceInEJBType(),
					orderDB.getCurrency(),
					storeAB,
					storeAB.getLanguageIdInEJBType())));
		out.print("          ");
		...
		out.println(
			UIUtil.toHTML(formatAmount(totalAdjust, orderDB.getCurrency(), storeAB, storeAB.getLanguageIdInEJBType())));
		out.print("          ");
		...
		out.println(
			UIUtil.toHTML(formatAmount(total, orderDB.getCurrency(), storeAB, storeAB.getLanguageIdInEJBType())));
		out.println("");
	}
	out.println(orderNotificationRB.getString("shortDelimeter"));
	out.println("");
