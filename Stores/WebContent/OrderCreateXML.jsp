...
(c) Copyright IBM Corp.  2000, 2002, 2007
All Rights Reserved
...
try
{
   ...
   if (odb.getStoreEntityIdInEJBType() != null)
   ...
   if (odb.getMemberIdInEJBType() != null)
   ...
   if (odb.getAddressIdInEJBType() != null)
   ...
   if (odb.getPlaceOrderTimeInEJBType() != null)
   {
   ...
   if (storeId != OrderCreateConstants.NOT_AVAILABLE)
   {
      ...
      if (sddb.getShipModeIdInEJBType() != null)
      ...
      if ((seddb.getContactAddressIdInEJBType()) != null)
	  {
   ...
   for(int i = 0; i < itemBean.length; i++)
   {
	  ...
	  if (itemBean[i].getAddressIdInEJBType() != null)
	  {
         AddressDataBean adb=new AddressDataBean();
    ...
    if (itemBean[i].getShippingModeIdInEJBType() != null)
      ...
      if (itemBean[i].getTimeCreatedInEJBType() != null)
	  {
		 ...
		 if (itemBean[i].getLastUpdateInEJBType() != null)
		 {
	  ...
	  if (itemBean[i].getField1InEJBType() != null)
