...
%><%!
private static final int HEADING_SIDE = 40;
private static final int NUMBER_SIDE = 40;
...
if (aStoreAB.getDefaultCurrency() != null) {
	...
	System.out.println("store commerce: default currency Id = " + currency);
}

if (aStoreAB.getLanguageId() != null) {
	languageId = aStoreAB.getLanguageId();
	System.out.println("store commerce: default language Id = " + languageId);
}
...
newRequestProperties.put("reportName", "ProductSalesReport");
newRequestProperties.put("reportXML", "reporting.ProductSalesReport");
...
newRequestProperties.put("LanguageID", languageId);
newRequestProperties.put("Currency", currency);
newRequestProperties.put("reportName", "RegionReport");
newRequestProperties.put("reportXML", "reporting.RegionReport");
request.setAttribute("RequestProperties", newRequestProperties);
...
if (format.equals("0")) {
	//text format
	out.println( orderNotificationRB.getString("StoreCommerceReportTitle") );

	out.print( orderNotificationRB.getString("StoreCommerceReportStore") );
	out.print(" ");
	out.println( aStoreEntDescAB.getDisplayName() );
	out.print( orderNotificationRB.getString("StoreCommerceReportStartDate") );
	out.print(" ");
	...
	out.print( orderNotificationRB.getString("StoreCommerceReportEndDate") );
	out.print(" ");
	...
	out.println("");
	out.println( orderNotificationRB.getString("StoreCommerceReportDescription") );
	out.println( orderNotificationRB.getString("shortDelimeter") );
	
	out.println( orderNotificationRB.getString("StoreCommerceReportProducts") );
	...
	out.println( orderNotificationRB.getString("shortDelimeter") );
	out.println(" ");
	out.println( orderNotificationRB.getString("StoreCommerceReportRegions") );
	out.println(" ");
