...
<%-- BEGIN DMartPDPProductInformationWidget.jsp --%>
...
<%@include file="DMartPDPProductInformationWidget_Data.jspf"%>
...
<%@ include file="DMartPDPProductInformationWidget_UI.jspf"%>

<%@ include file="/Widgets_701/Common/StorePreviewShowInfo_End.jspf" %>

<%-- END DMartPDPProductInformationWidget.jsp --%>
