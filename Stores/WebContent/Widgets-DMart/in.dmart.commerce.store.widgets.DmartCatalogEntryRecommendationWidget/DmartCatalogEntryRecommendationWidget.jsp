...
<%-- BEGIN DmartCatalogEntryRecommendationWidget.jsp --%>
...
<%@include file="DmartCatalogEntryRecommendationWidget_Data.jspf"%>
<c:if test="${env_inPreview && !env_storePreviewLink}">	
	<jsp:useBean id="previewWidgetProperties" class="java.util.LinkedHashMap" scope="page" />
	<c:set target="${previewWidgetProperties}" property="widgetUsage" value="${param.widgetUsage}" />
...
<%@ include file="DmartCatalogEntryRecommendationWidget_UI.jspf"%>

<%@ include file="/Widgets_701/Common/StorePreviewShowInfo_End.jspf" %>

<%-- END DmartCatalogEntryRecommendationWidget.jsp --%>
