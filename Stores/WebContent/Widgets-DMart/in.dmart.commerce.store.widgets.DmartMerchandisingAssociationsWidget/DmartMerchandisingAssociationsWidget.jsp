...
<%-- BEGIN DmartMerchandisingAssociationsWidget.jsp --%>
...
<%@include file="DmartMerchandisingAssociationsWidget_Data.jspf"%>
...
<%@ include file="DmartMerchandisingAssociationsWidget_UI.jspf"%>

<%@ include file="/Widgets_701/Common/StorePreviewShowInfo_End.jspf" %>

<%-- END DmartMerchandisingAssociationsWidget.jsp --%>
