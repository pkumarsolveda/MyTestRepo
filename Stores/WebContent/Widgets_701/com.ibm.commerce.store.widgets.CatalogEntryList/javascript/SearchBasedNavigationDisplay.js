				...
				if(byId("facet_" + id) == null) {
					...
					if(grouping) {
						...
						if(image != "") {
							...
							var checkmark = "<div class='checkBox'>" + "<div class='checkmark'></div>" + "</div></a>";
							facetLabel = facetLabel + checkmark + "<span class='outline'><span id='facetLabel_" + id + "'>" + label + "</span> (<span id='facet_count" + id +"'>" + count + "</span>)</span>";
						}
