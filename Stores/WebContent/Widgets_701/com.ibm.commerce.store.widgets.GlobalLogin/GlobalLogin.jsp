...
<script type="text/javascript" src="${staticAssetContextRoot}${env_siteWidgetsDir}com.ibm.commerce.store.widgets.GlobalLogin/javascript/GlobalLoginControllers.js"></script>
<script type="text/javascript" src="${staticAssetContextRoot}${env_siteWidgetsDir}com.ibm.commerce.store.widgets.GlobalLogin/javascript/GlobalLogin.js"></script>
<script type="text/javascript" src="${staticAssetContextRoot}${env_siteWidgetsDir}com.ibm.commerce.store.widgets.GlobalLogin/javascript/GlobalLoginShopOnBehalf.js"></script>
<script type="text/javascript" src="${staticAssetContextRoot}${env_siteWidgetsDir}com.ibm.commerce.store.widgets.GlobalLogin/javascript/GlobalLoginActions.js"></script>
