...
<script type="text/javascript" src="${staticAssetContextRoot}${env_siteWidgetsDir}Common/Approval/ApprovalContextsDeclarations.js"></script>
<script type="text/javascript" src="${staticAssetContextRoot}${env_siteWidgetsDir}Common/Approval/ApprovalControllersDeclarations.js"></script>
<script type="text/javascript" src="${staticAssetContextRoot}${env_siteWidgetsDir}Common/Approval/ApprovalServicesDeclarations.js"></script>
...
<div id="OrderApproval_table_summary" class="hidden_summary" aria-hidden="true">
	<fmt:message key="ORDERAPPROVAL_TABLE_SUMMARY" bundle="${widgetText}"/>
</div>
...
<div dojoType="wc.widget.RefreshArea" id="OrderApprovalTable_Widget" controllerId="OrderApprovalTable_Controller" aria-labelledby="OrderApproval_table_summary"
	ariaLiveId="${ariaMessageNode}" ariaMessage="<fmt:message key="ACCE_STATUS_ORDERAPPROVALLIST_UPDATED" bundle="${widgetText}" />">
	<%out.flush();%>
