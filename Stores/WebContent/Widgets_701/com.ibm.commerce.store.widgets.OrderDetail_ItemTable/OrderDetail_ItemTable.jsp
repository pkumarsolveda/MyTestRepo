...
<script type="text/javascript" src="${staticAssetContextRoot}${env_siteWidgetsDir}Common/OrderDetail/OrderDetailContextsDeclarations.js"></script>
<script type="text/javascript" src="${staticAssetContextRoot}${env_siteWidgetsDir}Common/OrderDetail/OrderDetailControllersDeclarations.js"></script>
...
<div id="OrderDetailItems_table_summary" class="hidden_summary" aria-hidden="true">
	<fmt:message key="ORDERDETAIL_TABLE_SUMMARY" bundle="${widgetText}"/>
</div>
