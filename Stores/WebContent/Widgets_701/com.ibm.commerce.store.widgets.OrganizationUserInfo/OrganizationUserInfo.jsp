...
<fmt:message key="ORGANIZATIONUSER_CREATE_SUCCESS" bundle="${widgetText}" var="ORGANIZATIONUSER_CREATE_SUCCESS"/>
<script type="text/javascript" src="${staticAssetContextRoot}${env_siteWidgetsDir}com.ibm.commerce.store.widgets.OrganizationUserInfo/javascript/OrganizationUserInfo.js"></script>
<script type="text/javascript" src="${staticAssetContextRoot}${env_siteWidgetsDir}com.ibm.commerce.store.widgets.OrganizationUserInfo/javascript/OrganizationUserInfoControllers.js"></script>
