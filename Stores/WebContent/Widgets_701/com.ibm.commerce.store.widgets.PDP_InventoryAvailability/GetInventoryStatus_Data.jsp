		...
		<c:when test="${!empty itemInventory.physicalStoreName}">
			...
			<c:choose>
				...
				<c:otherwise>
					...
					<fmt:message key="INV_STATUS_${itemInventory.inventoryStatus}" var="inventoryStatusText" bundle="${widgetText}"/>
					<fmt:message key="IMG_NAME_${itemInventory.inventoryStatus}" var="imageName" bundle="${widgetText}"/>
					<fmt:message key="IMG_INV_STATUS_${itemInventory.inventoryStatus}" var="altText" bundle="${widgetText}"/>
				</c:otherwise>
			</c:choose>
