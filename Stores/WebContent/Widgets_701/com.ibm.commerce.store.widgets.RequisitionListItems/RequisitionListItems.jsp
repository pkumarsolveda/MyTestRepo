...
<script type="text/javascript" src="${staticAssetContextRoot}${env_siteWidgetsDir}Common/RequisitionList/RequisitionListContextsDeclarations.js"></script>
<script type="text/javascript" src="${staticAssetContextRoot}${env_siteWidgetsDir}Common/RequisitionList/RequisitionListControllersDeclarations.js"></script>
<script type="text/javascript" src="${staticAssetContextRoot}${env_siteWidgetsDir}Common/RequisitionList/RequisitionListServicesDeclarations.js"></script>
...
<div id="ReqListItems_table_summary" class="hidden_summary" aria-hidden="true">
	<fmt:message key="REQUISITIONLISTITEMS_TABLE_SUMMARY" bundle="${widgetText}"/>
</div>
