...
<script type="text/javascript" src="${staticAssetContextRoot}${env_siteWidgetsDir}com.ibm.commerce.store.widgets.UserMemberGroupManagement/javascript/UserMemberGroupManagement.js"></script>
<script type="text/javascript" src="${staticAssetContextRoot}${env_siteWidgetsDir}com.ibm.commerce.store.widgets.UserMemberGroupManagement/javascript/UserMemberGroupManagementControllers.js"></script>
<fmt:message key="USERMEMBERGROUPMANAGEMENT_UPDATE_SUCCESS" bundle="${widgetText}" var="USERMEMBERGROUPMANAGEMENT_UPDATE_SUCCESS"/>
...
<div dojoType="wc.widget.RefreshArea" widgetId="<c:out value='${widgetName}'/>" id="<c:out value='${widgetName}'/>" 
	...
	ariaLiveId="${ariaMessageNode}" ariaMessage='<fmt:message key="ACCE_${widgetNameCaps}_UPDATED" bundle="${widgetText}" />' tabindex="0" class="UserMemberGroupManagement">
