...
<script type="text/javascript" src="${staticAssetContextRoot}${env_siteWidgetsDir}com.ibm.commerce.store.widgets.UserRoleManagement/javascript/UserRoleManagement.js"></script>
<script type="text/javascript" src="${staticAssetContextRoot}${env_siteWidgetsDir}com.ibm.commerce.store.widgets.UserRoleManagement/javascript/UserRoleManagementControllers.js"></script>
<fmt:message key="USERROLEMANAGEMENT_UPDATE_SUCCESS" bundle="${widgetText}" var="USERROLEMANAGEMENT_UPDATE_SUCCESS"/>
<fmt:message key="USERROLEMANAGEMENT_CHAINCREATE_FAIL" bundle="${widgetText}" var="USERROLEMANAGEMENT_CHAINCREATE_FAIL"/>
<fmt:message key="USERROLEMANAGEMENT_UNASSIGN_FAIL" bundle="${widgetText}" var="USERROLEMANAGEMENT_UNASSIGN_FAIL"/>
<fmt:message key="USERROLEMANAGEMENT_CONFIRMATIONDIALOGMESSAGE" bundle="${widgetText}" var="USERROLEMANAGEMENT_CONFIRMATIONDIALOGMESSAGE"/>
