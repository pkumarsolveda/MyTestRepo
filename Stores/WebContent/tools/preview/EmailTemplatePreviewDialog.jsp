...
<%  
	...
	WcParam wcparam = (WcParam) request.getAttribute(ECConstants.EC_INPUT_PARAM);

	String templateType = (String)request.getParameter("templateType");
	if (templateType == null){
	    templateType = (String)wcparam.get("templateType");
	}
	
	String messageId = (String)request.getParameter("messageId");
	if (messageId == null){
	    messageId = (String)wcparam.get("messageId");
	}
	
	String previewRequestFrom = (String)request.getParameter("previewRequestFrom");
	if (previewRequestFrom == null){
	    previewRequestFrom = (String)wcparam.get("previewRequestFrom");
	}

	String storeId = request.getParameter(ECConstants.EC_STORE_ID);
	if (storeId == null){
	    storeId = (String)wcparam.get("storeId");
	}
